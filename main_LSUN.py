...
#read in the data and resize to 64*64
def LSUN_dataset(path='./datasets/lsun', dataset='bedroom_train',):
    # Compose transforms
    ...
    # Get dataset
    return LSUN(db_path=path, classes=[dataset],transform=transform)
dataset=LSUN_dataset()
